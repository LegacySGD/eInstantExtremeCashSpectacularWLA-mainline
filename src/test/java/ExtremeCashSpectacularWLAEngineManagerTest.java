...
public class ExtremeCashSpectacularWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ExtremeCashSpectacularWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ExtremeCashSpectacularWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ExtremeCashSpectacularWLAIW/InitOutcome.xml").getDocumentElement();
